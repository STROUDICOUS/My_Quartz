...
<hr>
<p><em>If you have received the email above, you will be able to use this Gmail Link (if you use Gmail) or copy the search criteria into your email search to find it.</em>  </p>
...
Search Criterea:
<code>Subject: Garden Gate recieved: 2019-08-11</code></p>
</div></div></span></p>